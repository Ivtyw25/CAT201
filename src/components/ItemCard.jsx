...
const ItemCard = ({title, description, rating, price, image, index}) => {
  return (
    <div className="flex flex-col sm:flex-row shadow-2xl cursor-pointer hover:scale-105 transform transition-all duration-300 rounded-xl">
      <div className="relative min-w-64 min-h-64 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 overflow-hidden rounded-lg">
        <img
          src={image}
          alt={title}
      ...
      <div className="ml-0 sm:ml-8 mt-4 sm:mt-0 flex flex-col p-5 gap-2">
